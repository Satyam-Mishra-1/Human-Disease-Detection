...
//       const prompt = `You are an expert for any disease diagnosis analyst. Use your knowledge base to answer questions about giving personalized recommended treatments.
...
//                       Analysis Result
//                     </h2>
//                     <div className="space-y-2 text-red-500 font-bold">
...
function SingleRecordDetails() {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      const prompt = `You are an expert for any disease diagnosis analyst. Use your knowledge base to answer questions about giving personalized recommended treatments.
        give a detailed treatment plan for Home treatment which should we followed , what precautions should be taken and what preventive measures should we followed In order to prevent it, make it more readable, clear and easy to understand make it paragraphs to make it more readable
        `;
